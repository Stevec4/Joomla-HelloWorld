...
class HelloWorldModelHelloWorld extends JModelItem
{
	...
	public function getItem($id = null)
	{
		if (!isset($this->item) || !is_null($id)) 
		{
			...
			$query->select('h.greeting, h.params, h.image as image, c.title as category, h.latitude as latitude, h.longitude as longitude, h.id as id, h.alias as alias, h.catid as catid, h.parent_id as parent_id, h.level as level')
